package com.cxy.gamemanager.download.utils;
...
public class Constant {
    ...
    public final static String FILE_PATH = Environment.getExternalStorageDirectory().getAbsolutePath()+"/download/";

    /**
     * 若文件下载不下来，更换网址
     */
    public final static String URL_1 = "https://raw.githubusercontent.com/zzhiyou/test/master/MyGameTest.apk";
    ...
    //版本信息
    public final static String VERSION_URL = "https://raw.githubusercontent.com/zzhiyou/test/master/version";
